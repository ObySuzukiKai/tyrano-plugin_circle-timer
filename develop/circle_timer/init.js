...
class TyranoPluginCircleTimer {
    ...
    constructor(pm){
        ...
        if (!!pm.front_graphic && pm.front_graphic !== 'none') {
            ...
            this.front_graphic.obj = new TyranoPluginCircleTimerImage(this.front_graphic.pass,this.canvas_width,this.canvas_height);
        } else this.front_graphic = null;
        if (!!pm.back_graphic && pm.back_graphic !== 'none') {
            this.back_graphic = {
                pass: './data/image/' + pm.back_graphic,
            };
            this.back_graphic.obj = new TyranoPluginCircleTimerImage(this.back_graphic.pass,this.canvas_width,this.canvas_height);
        } else this.back_graphic = null;
        if (!!pm.end_graphic && pm.end_graphic !== 'none') {
            this.end_graphic = {
                pass: './data/image/' + pm.end_graphic,
            };
            this.end_graphic.obj = new TyranoPluginCircleTimerImage(this.end_graphic.pass,this.canvas_width,this.canvas_height);
